                ...
                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td class="content-cell">
                      <h1>Hi ${name},</h1>
                      <p>You recently requested to reset your password for your Exalt account. Click the button below to reset it.</p>
                      <!-- Action -->
                        ...
                        <tr>
                          <td align="center">
                            <div>
                              ...
                              <a href="${link}" class="button button--red">Reset your password</a>
                            </div>
                          </td>
                        </tr>
                      </table>
            ...
            <tr>
              <td>
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="content-cell">
                      <p class="sub center">&copy; ${new Date().getFullYear()} Tipestry. All rights reserved.</p>
                      <p class="sub center">
                        Tipestry
                      </p>
                    </td>
